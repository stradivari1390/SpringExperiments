    ...
    $(function () {
                                ...
                                switch (v) {
                                    ...
                                    case'mail':
                                        if ($this.val() !== '' && !$this.val().match(/\w+@\w+\.\w+/) && !$this.prop('disabled')) {
                                            message += 'Enter your e-mail adress: xxx@xxx.xx';
                                            error = true;
                                        }
                                        break;
                                    case'key':
                                ...
                                $.ajax({
                                    ...
                                    complete: function (result) {
                                        if (result.status === 200) {
                                            ...
                                            var foundText = $Middle.find('.Middle-searchHeader').data('found-text');
                                            $Middle.find('.Middle-searchHeader').text(foundText + ' ' +
                                                result.responseJSON.count +
                                            ...
                                            alert('Wrong query ' + result.status);
                                            location.reload();
                                        }
                                    }
                                });
        ...
        var Card = function () {
            var bookTemplate = function (book) {
                return '<div class="Card">' +
                    ...
                    '       <img src="' + book.image + '">\n' +
                    (book.discount !== 0 ? '<div class="Card-sale">-' + book.discount + '%</div>' : '') +
                    '</a>' +
                    '    </div>' +
                    '    <div class="Card-content">\n' +
                    '        <div class="Card-title"><a href="/books/' + book.slug + '">' + book.title + '</a>\n' +
                    '        </div>\n' +
                    '        <div class="Card-description">' + book.authorFirstName + ' ' + book.authorLastName + '</div>\n' +
                    '        <div class="Card-cost">' +
                    (book.discount !== 0 ? '<span class="Card-priceOld">₽' + new Intl.NumberFormat('ru-RU', {minimumFractionDigits: 2, maximumFractionDigits: 2}).format(book.price) + '</span>\n' : '') +
                    '            <span class="Card-price">₽' + new Intl.NumberFormat('ru-RU', {minimumFractionDigits: 2, maximumFractionDigits: 2}).format(book.price * (100 - book.discount) / 100) + '</span>\n' +
                    '        </div>\n' +
                    '    </div>\n' +
                    ' </div>';
            }
                    ...
                    $('[data-refreshshow]').on('click change', function (e) {
                        ...
                        switch (data) {
                                ...
                                if (e.type === 'change') {
                                    ...
                                    if (!$this.hasClass('form-input_date_uninit')) {
                                        ...
                                        getData('/api/books/recent', {
                                            fromDate: formatDate($('[data-refreshfrom]').data('refreshfrom')),
                                            toDate: formatDate($('[data-refreshto]').data('refreshto')),
                            ...
                            case'popular':
                                ...
                                break;
                            case'genre':
                                getData('/api/books/genre', {
                                    genre: $this.data('refreshid'),
                                    offset: $this.data('refreshoffset'),
                                    limit: $this.data('refreshlimit')
                                });
                                break;
                            case'author':
                                getData('/api/books/author', {
                                    authorSlug: $this.data('refreshid'),
                                    offset: $this.data('refreshoffset'),
                                    limit: $this.data('refreshlimit')
                                });
                                break;
                ...
                init: function () {
                    ...
                    $('[data-likeid]').on('click', function (e) {
                        ...
                        if ($this.hasClass('btn_like')) {
                            data.value = 1;
                        } else if ($this.hasClass('btn_dislike')) {
                            data.value = -1;
                        } else {
                            data.value = 0;
                        }
                        ...
                        $.ajax({
                            ...
                            error: function (jqXHR, textStatus, errorThrown) {
                                window.alert('review rating denied');
                ...
                init: function () {
                    ...
                    $('#submitPhone').on('click', function () {
                        ...
                        postData('/requestContactConfirmation', data, function (result) {
                            if (result.result) {
                                $this.after('<div class="form-info">Code sent you in SMS</div>')
                    ...
                    $('#submitMail').on('click', function () {
                        ...
                        postData('/requestContactConfirmation', data, function (result) {
                            if (result.result) {
                                $this.after('<div class="form-info">Code sent to your e-mail</div>')
                                $this.attr('disabled', 'disabled');
                                $row.addClass('form-group_confirm');
                                $row.find('.form-error').remove();
                            } else {
                        ...
                        if (!$this.hasClass('form-input_error')) {
                            postData('/approveContact', data, function (result) {
                                if (result.result) {
                                    ...
                                    $but.after('<div class="form-info">Code accepted</div>');
                                    $this.trigger('change');
                                } else {
                                    if (result) {
                    ...
                    $entryButton.on('click', function (e) {
                        ...
                        if ($this.is('[data-send]')) {
                            ...
                            if (!error) {
                                postData('/login', $this.data('send'), function (loginResult) {
            ...
            return {
                init: function () {
                    ...
                    $btnSend.on('click', function (e) {
                        ...
                        if (status === 'REMOVE_FROM_CART') {
                            e.preventDefault();
                            $.ajax({
                                url: '/changeBookStatus/cart/remove/' + bookId,
                                type: 'POST',
                                success: function (result) {
                                    location.reload();
                                },
                        ...
                        } else if (status === 'REMOVE_FROM_POSTPONED') {
                            e.preventDefault();
                            $.ajax({
                                url: '/changeBookStatus/postponed/remove/' + bookId,
                                type: 'POST',
                                success: function (result) {
                                    location.reload();
                                },
                        ...
                        } else if (status === 'MASS_CART') {
                            e.preventDefault();
                            $.ajax({
                                url: '/changeBookStatus/' + bookId + '?status=MASS_CART',
                                type: 'POST',
                                success: function (result) {
                            ...
                            e.preventDefault();
                            $.ajax({
                                url: '/changeBookStatus/' + bookId + '?status=KEPT',
                                type: 'POST',
                                success: function (result) {
                                    location.reload();
                                },
                            ...
                            e.preventDefault();
                            $.ajax({
                                url: '/changeBookStatus/' + bookId + '?status=CART',
                                type: 'POST',
                                success: function (result) {
                                    location.reload();
                                },
                            ...
                            e.preventDefault();
                            $.ajax({
                                url: '/changeBookStatus/' + bookId + '?status=ARCHIVED',
                                type: 'POST',
                                success: function (result) {
                                    location.reload();
                                },
                            ...
                            Login().postData('/changeBookStatus/' + bookId, {
                                status: status
                            }, function (result) {
                                if (result.result) {
                    ...
                    $ProductAssesment.find('.Rating input').on('change', function (e) {
                        ...
                        $.ajax({
                            ...
                            success: function (result) {
                                Cookies.set('bookRating-' + $this.closest('.Rating').data('bookid'), $this.val());
                                $this.closest('.Rating').find('input').prop('disabled', true);
                            ...
                            error: function (jqXHR, textStatus, errorThrown) {
                                window.alert('Only authorized users can rate a book');
                                console.error('Error: ' + textStatus + ' ' + errorThrown);
                            }
                        });
                    });
            ...
            return {
                init: function () {
                    ...
                    $('.Rating').each(function () {
                        ...
                        var savedRating = Cookies.get('bookRating-' + bookId);
                        if (savedRating) {
                            $(this).find('input[value="' + savedRating + '"]').prop('checked', true);
                                ...
                                if ($(slick.$slides[slick.$slides.length - 3]).hasClass('slick-active')) {
                                    ...
                                    if ($(slick.$slider).data('load')) {
                                        ...
                                        function sendData(address) {
                                            if ($(slick.$slider).data('hasmore') === false) {
                                                return;
                                            }
                                            getData(address, {
                                                offset: function () {
                                                ...
                                                fromDate: $(slick.$slider).data('fromDate'),
                                                toDate: $(slick.$slider).data('toDate'),
                                                authorSlug: $(slick.$slider).data('authorSlug'),
                                                userId: $(slick.$slider).data('userId')
                                            }, function (result) {
                                                if (result.books.length === 0) {
                                                    $(slick.$slider).data('hasmore', false);
                                                } else {
        ...
        var Transactions = function () {
            ...
            var transactionTemplate = function (transaction) {
                var date = new Date(+transaction.time), // this is in UTC
                    localDate = new Date(date.getTime() - date.getTimezoneOffset() * 60000), // convert to local time
                ...
                return '<tr>\n' + '                      <td>' +
                    ...
                    localDate.getHours() + ':' +
                    localDate.getMinutes() + '                      </td>\n' + '                      <td><span class="Transactions_textSuccess">\n' + '                          <strong>' + Number(transaction.value).toFixed(2) + ' $\n' + '                          </strong></span>\n' + '                      </td>\n' + '                      <td>' + transaction.description + '                      </td>\n' + '                    </tr>';
            }

            function getData(address, data, append) {
                var scroll = $(window).scrollTop();
                $.ajax({
                    url: address,
                    type: 'GET',
                    ...
                    complete: function (result) {
                        if (result.status === 200) {
                            ...
                            if (append) {
                                ...
                                $('.Transactions tbody').html(data);
                            }
                            $(window).scrollTop(scroll);
                            if (offset > 0) {
                                $('.Transactions-less').show();
                            } else {
                                $('.Transactions-less').hide();
                            }
                            if (result.responseJSON.length < limit) {
                                $('.Transactions-get').hide();
                            } else {
                                $('.Transactions-get').show();
                            }
                        } else {
                            alert('Ошибка ' + result.status);
                        }
            ...
            return {
                init: function () {
                    ...
                    $('.Transactions-less').on('click', function (e) {
                        e.preventDefault();
